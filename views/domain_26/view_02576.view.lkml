...
# Description: Defines dimensions, measures, sets, and table references for view_02576.
...
view: view_02576 {
  ...
  dimension: id {
    ...
    description: "Dimension id for view view_02576"
    sql: ${TABLE}.id ;;
    primary_key: yes
    hidden: no
  }
  ...
  dimension: created_at {
    ...
    description: "Dimension created_at for view view_02576"
  ...
  dimension: updated_at {
    type: time
    group_label: "Timestamps"
    description: "Dimension updated_at for view view_02576"
  ...
  dimension: deleted_at {
    type: time
    group_label: "Timestamps"
    description: "Dimension deleted_at for view view_02576"
  ...
  dimension: status {
    ...
    description: "Dimension status for view view_02576"
    sql: ${TABLE}.status ;;
  ...
  dimension: category {
    type: string
    group_label: "Attributes"
    description: "Dimension category for view view_02576"
    sql: ${TABLE}.category ;;
  ...
  dimension: subcategory {
    type: string
    group_label: "Attributes"
    description: "Dimension subcategory for view view_02576"
  ...
  dimension: user_id {
    ...
    description: "Dimension user_id for view view_02576"
    sql: ${TABLE}.user_id ;;
    hidden: yes
  }
  ...
  dimension: account_id {
    ...
    description: "Dimension account_id for view view_02576"
  ...
  dimension: organization_id {
    type: number
    group_label: "Account Info"
    description: "Dimension organization_id for view view_02576"
    sql: ${TABLE}.org_id ;;
    hidden: yes
  }
  ...
  dimension: amount_cents {
    ...
    description: "Dimension amount_cents for view view_02576"
  ...
  dimension: amount {
    type: number
    group_label: "Financials"
    description: "Dimension amount for view view_02576"
  ...
  dimension: tax_amount {
    type: number
    group_label: "Financials"
    description: "Dimension tax_amount for view view_02576"
  ...
  dimension: discount_amount {
    type: number
    group_label: "Financials"
    description: "Dimension discount_amount for view view_02576"
  ...
  dimension: shipping_fee {
    type: number
    group_label: "Financials"
    description: "Dimension shipping_fee for view view_02576"
  ...
  dimension: currency_code {
    type: string
    group_label: "Financials"
    description: "Dimension currency_code for view view_02576"
  ...
  dimension: country_code {
    ...
    description: "Dimension country_code for view view_02576"
  ...
  dimension: state_province {
    type: string
    group_label: "Geography"
    description: "Dimension state_province for view view_02576"
  ...
  dimension: city {
    type: string
    group_label: "Geography"
    description: "Dimension city for view view_02576"
    sql: ${TABLE}.city ;;
  }
  ...
  dimension: postal_code {
    type: zipcode
    group_label: "Geography"
    description: "Dimension postal_code for view view_02576"
  ...
  dimension: is_active {
    type: yesno
    group_label: "Flags"
    description: "Dimension is_active for view view_02576"
  ...
  dimension: is_deleted {
    type: yesno
    group_label: "Flags"
    description: "Dimension is_deleted for view view_02576"
  ...
  dimension: is_verified {
    type: yesno
    group_label: "Flags"
    description: "Dimension is_verified for view view_02576"
  ...
  dimension: tier {
    ...
    description: "Dimension tier for view view_02576"
  ...
  dimension: email_domain {
    type: string
    group_label: "User Info"
    description: "Dimension email_domain for view view_02576"
  ...
  dimension: device_type {
    ...
    description: "Dimension device_type for view view_02576"
  ...
  dimension: channel {
    ...
    description: "Dimension channel for view view_02576"
  ...
  dimension: campaign_name {
    type: string
    group_label: "Marketing"
    description: "Dimension campaign_name for view view_02576"
  ...
  dimension: score {
    ...
    description: "Dimension score for view view_02576"
